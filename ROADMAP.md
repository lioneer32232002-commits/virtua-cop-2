...
- **🎬 三部曲弧線**（2026-06-17 用戶揭示＋拍板）：**首部曲＝1953**（First Island Chain，**＝MVP／比賽版**，自己人腐敗出賣暗線名單）→ **第二部曲＝1996**（台灣首次民選總統＋**台海飛彈危機**，「北方用飛彈回應島嶼的第一張選票」，承 spec 結尾**已埋的 1996 鉤子**）→ **第三部曲＝當代/習時代**（北方威權強化＋對島野心）。**當代段拍板＝一致虛構化**：「北方」的威權強化／領導人更迭／對島野心，**不指名習近平**（史實上他是國家主席/總書記非總理；但重點是不指名），與 1953 段批國民黨**同一原則**。理由＝一視同仁的虛構化才是 le Carré「誰也不乾淨」道德高度的基石；指名會變雙重標準＋反共宣傳標籤＋引爆審查（《還願》放大版）＋綁死一個人（卸任即過期）＋限縮受眾；虛構化＝《1984》式寓言（領導人會換、寓言不朽）、批判 100% 保留、受眾最大、相容 §13。1996 飛彈危機畫面本身即最強控訴、無需點名。**範圍：MVP 只做首部曲；二/三部曲是後續，部曲遞增（承首部曲 spec），當代段細節等真正開第三部曲再深化。**

---

> **📍 2026-06-17 之後的進度改記在 `docs/HANDOFF-*.md`（取日期最新一份）**，本檔只留里程碑級標記。分支 `feat/milestone-e-art` 上已陸續落地：M3 視覺層、E3 開火 tell、decode-gating（對位窗＋紙片鑰匙）、v3 敘事換皮（自己人出賣／林建國／戚將軍線）。
